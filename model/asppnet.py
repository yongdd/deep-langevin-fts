...
class LitAsppNet(pl.LightningModule):
    def __init__(self, dim, in_channels=3, mid_channels = 32, out_channels=1, kernel_size=3):
        ...
        if dim == 1:
            ...
            self.conv_aspp4_1 = nn.Conv1d(mid_channels, mid_channels//2, 1, bias=False)
            self.conv_aspp4_2 = nn.Conv1d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*2, padding_mode='circular', dilation=2)
            self.conv_aspp4_3 = nn.Conv1d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*4, padding_mode='circular', dilation=4)
            self.conv_aspp4_4 = nn.Conv1d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*8, padding_mode='circular', dilation=8)

            self.conv5 = nn.Conv1d(mid_channels*2, mid_channels, kernel_size, bias=False, padding=padding, padding_mode='circular')
            self.conv6 = nn.Conv1d(mid_channels,   mid_channels, kernel_size, bias=False, padding=padding, padding_mode='circular')
            ...
            self.bm4_1 = nn.BatchNorm1d(mid_channels//2)
            self.bm4_2 = nn.BatchNorm1d(mid_channels//2)
            self.bm4_3 = nn.BatchNorm1d(mid_channels//2)
            self.bm4_4 = nn.BatchNorm1d(mid_channels//2)
            ...
            self.conv_aspp4_1 = nn.Conv2d(mid_channels, mid_channels//2, 1, bias=False)
            self.conv_aspp4_2 = nn.Conv2d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*2, padding_mode='circular', dilation=2)
            self.conv_aspp4_3 = nn.Conv2d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*4, padding_mode='circular', dilation=4)
            self.conv_aspp4_4 = nn.Conv2d(mid_channels, mid_channels//2, kernel_size, bias=False, padding=padding*8, padding_mode='circular', dilation=8)

            self.conv5 = nn.Conv2d(mid_channels*2, mid_channels, kernel_size, bias=False, padding=padding, padding_mode='circular')
            ...
            self.bm4_1 = nn.BatchNorm2d(mid_channels//2)
            self.bm4_2 = nn.BatchNorm2d(mid_channels//2)
            self.bm4_3 = nn.BatchNorm2d(mid_channels//2)
            self.bm4_4 = nn.BatchNorm2d(mid_channels//2)
