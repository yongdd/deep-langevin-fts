...
params = {
    ...
    "chi_n":22.9114,            # Interaction parameter, Flory-Huggins params * N
...
simulation.run(w_minus=input_data["w_minus"], w_plus=input_data["w_plus"],
    max_step=100, model_file="sphere_atr_cas_mish_32.pth")

# Recording first a few iteration results for debugging and refactoring

# ---------- model file : sphere_atr_cas_mish_32.pth ----------
#        1    1.998E-15  [ 2.1378249E+04  ]     7.017849994   7.2090707E-05
# iteration, mass error, total_partitions, energy_total, error_level
# ---------- Run  ----------
# Langevin step:  1
#        4    2.665E-15  [ 2.1709134E+04  ]     7.026003870   2.2191396E-05
#        2    8.660E-15  [ 2.1420921E+04  ]     7.015319841   7.5623148E-05
# Langevin step:  2
#        4   -5.551E-15  [ 2.1719041E+04  ]     7.032860628   4.5235690E-05
#        2    3.109E-15  [ 2.1391070E+04  ]     7.021855731   7.3415320E-05
# Langevin step:  3
#        4    1.110E-15  [ 2.1541632E+04  ]     7.041428880   3.1033576E-05
#        2   -2.220E-15  [ 2.1231575E+04  ]     7.030308927   7.4283354E-05
# Langevin step:  4
#        4   -2.887E-15  [ 2.1853478E+04  ]     7.044440959   3.6709661E-05
#        2   -4.219E-15  [ 2.1524765E+04  ]     7.033475692   7.2509679E-05
# Langevin step:  5
#        4    8.882E-16  [ 2.1976649E+04  ]     7.039501932   3.1868907E-05
#        2   -1.332E-15  [ 2.1686533E+04  ]     7.028882516   7.6081597E-05