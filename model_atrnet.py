...
class AtrNet(torch.nn.Module):
    def __init__(self, dim, in_channels=3, mid_channels = 128, out_channels=1, kernel_size = 5):
        ...
        if dim == 1:
            ...
            self.conv5 = torch.nn.Conv2d(mid_channels, mid_channels, kernel_size, padding=padding*4, padding_mode='circular', dilation=4)
            ...
            self.conv5 = torch.nn.Conv3d(mid_channels, mid_channels, kernel_size, padding=padding*4, padding_mode='circular', dilation=4)
