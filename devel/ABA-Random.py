...
params = {
    ...
    "chi_n":25.0,               # Interaction parameter, Flory-Huggins params * N_Ref
...
simulation.make_training_dataset(w_minus=w_minus, w_plus=w_plus, final_fields_configuration_file_name="LastTrainingLangevinStep.mat")
